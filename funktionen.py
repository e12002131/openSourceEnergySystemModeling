...
def addLoad(df_synthload_in, df_load_profile_in, load_profile, yearly_energy_consumption):
    ...
    df_load_profile_temp['load'] = df_load_profile_temp['load'] + df_synthload_in[load_profile] * yearly_energy_consumption * 4
...
def pickDay(df_load_profile_in, day_of_year):
    ...
    df_load_profile_temp = df_load_profile_temp.where(df_load_profile_temp['day of year'] == day_of_year)
